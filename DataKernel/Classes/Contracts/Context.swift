...
public protocol Context {
    func fetch<E>(_ request: Request<E>) throws -> [E]
    func count<E>(_ request: Request<E>) throws -> Int
    ...
    func remove<E>(_ condition: Request<E>) throws // removes all entities that satisfies condition
